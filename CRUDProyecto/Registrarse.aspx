<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registrarse.aspx.cs" Inherits="CRUDProyecto.Registrarse" %>
        ...
        <div class="container d-flex justify-content-center align-items-center min-vh-100">
            ...
            <div class="card shadow-lg" style="width: 100%; max-width: 500px; border-radius: 15px;">
                <div class="card-body">
                    ...
                    <h2 class="text-center mb-4" style="font-family: 'Georgia', serif; color: #5D5B8D;">Registro</h2>
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnGuardar" runat="server" Text="Registarse" OnClick="Guardar" CssClass="btn btn-primary w-100" />
                    </div>
                </div>
            </div>
        </div>
